public class Main{
    ...
    public static void main(String[] args){
        ...
        if (monitor.color.equals(monitor1.color)){
            ...
            System.out.println("Monitors have different colors. First has " + monitor.color + " color, the second one has " + monitor1.color + " color.");
        }
        ...
        if (monitor.resolution.equals(monitor1.resolution)){
            ...
            System.out.println("Monitors have different resolutions. First has " + monitor.resolution + " resolution, the second one has " + monitor1.resolution + " resolution.");
        }
